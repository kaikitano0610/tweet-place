    ...
    <div class="row justify-content-center">
            ...
            <div class="card mt-4">
                <div class="d-inline-flex">
                    <div class="p-3 d-flex flex-column">
                        ...
                        <div class="mt-3 d-flex flex-columun">
                            <h4 class="mb-0 font-weight-bold">{{ $user->name }}</h4>
                            <span class="text-secondary">{{ $user->screen_name}}</span>
                        </div>
                    </div>
                    <div class="p-3 d-flex flex-columun justify-content-between">
                        <div class="d-flex">
                            <div>
                                @if ($user->id === Auth::user()->id)
                                    <a href="{{ url('users/' . $user->id .'edit') }}" class="btn btn-primary">プロフィールを編集</a>
        ...
        @if (isset($timelines))
            @foreach ($timelines as $timeline)
                <div class="col-md-8 mb-3">
                    <div class="card">
                        <div class="card-header p-3 w-100 de-flex">
